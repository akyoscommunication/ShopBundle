...
/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_FormFields__ = __webpack_require__(6);


class Form {
    static init() {
        __WEBPACK_IMPORTED_MODULE_0__modules_FormFields__["a" /* default */].init();
    }
}
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery_ui_ui_widgets_sortable__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CoreBundle_assets_scripts_modules_Toast__ = __webpack_require__(11);
...
class FormFields {
            ...
            update: function (event, ui) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res === 'valid') {
                            new __WEBPACK_IMPORTED_MODULE_1__CoreBundle_assets_scripts_modules_Toast__["a" /* default */]('Changement de position effectué', 'success', 'Succès', 5000);
                        } else {
                            // TODO : error
                        }
                    },
                    error: function (er) {
                        ...
                        new __WEBPACK_IMPORTED_MODULE_1__CoreBundle_assets_scripts_modules_Toast__["a" /* default */]('Une erreur s\'est produite lors du changement de position...', 'danger', 'Une erreur s\'est produite...', 5000);
                    }
                });
            }
        });
    ...
    static ajaxContactFormFieldEdit() {
        $('.btn-modal-contactformfield').click(function (e) {
            ...
            fetch('/admin/contact/form/field/' + data + '/edit').then(function (res) {
